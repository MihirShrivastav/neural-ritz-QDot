...
For a conventional finite-difference orbital baseline passed through the same pair-CI solver:
...
To run both baselines and comparison in one controlled benchmark folder:
